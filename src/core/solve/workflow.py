...
from src.core.solve.node_logic import (pdftostr_wrapper,
                                       extract_test_cases_wrapper,
                                       get_summary, create_prompt,
                                       call_model, validate_wrapper,
                                       should_continue,
                                       pass_validation,
                                       compilation_wrapper,
                                       pass_compilation,
...
def iterate ():
    ...
    workflow.add_conditional_edges ("implementer", should_continue, {"continue": "impl_action", "end": "compilation"})
    workflow.add_edge ("impl_action", "implementer")

    workflow.add_conditional_edges ("compilation", pass_compilation, {"continue": "validation", "retry": "create_prompt"})
