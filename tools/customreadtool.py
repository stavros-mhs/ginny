...
class ReadFileInput(BaseModel):
    ...
    file_path: str = Field(..., description="name of file") # is description needed? how can I use it to make the model more efficient?
...
class ReadFileTool(BaseFileToolMixin, BaseTool):  # type: ignore[override, override]
    ...
    description: str = "Read file from disk"
                                    ...
                                    # what is run_manager doing? I don't understand
