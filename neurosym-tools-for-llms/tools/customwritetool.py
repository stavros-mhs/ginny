...
class WriteFileInput(BaseModel):
    ...
    reason: str = Field(description="In up to 512 characters, explain what you are writing.")
    append: bool = Field(
...
class WriteFileTool(BaseFileToolMixin, BaseTool):  # type: ignore[override, override]
    ...
    def _run(self, file_path: str, text: str, reason: str, append: bool = False) -> str:
        try:
            print(f"## {reason}")
